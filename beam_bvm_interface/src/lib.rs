...
pub mod root {
    ...
    pub mod Env {
        ...
        use self::super::super::root;
        extern "C" {
            pub fn Write(pData: *const ::std::os::raw::c_void, nData: u32, iStream: u32);
        }
        extern "C" {
            pub fn Memcpy(
        ...
        extern "C" {
            pub fn UpdateShader(pVal: *const ::std::os::raw::c_void, nVal: u32);
        }
        extern "C" {
        ...
        extern "C" {
            pub fn GenerateRandom(pBuf: *mut ::std::os::raw::c_void, nSize: u32);
        }
        extern "C" {
            pub fn get_SlotImage(res: *mut root::Secp_point, iSlot: u32);
        }
        extern "C" {
            pub fn SlotInit(pExtraSeed: *const ::std::os::raw::c_void, nExtraSeed: u32, iSlot: u32);
        }
        extern "C" {
            pub fn get_Pk(res: *mut root::Secp_point, pID: *const ::std::os::raw::c_void, nID: u32);
        }
        extern "C" {
            pub fn get_BlindSk(
        ...
        extern "C" {
            pub fn Comm_Listen(pID: *const ::std::os::raw::c_void, nID: u32, nCookie: u32);
        }
        extern "C" {
            pub fn Comm_Send(
                pkRemote: *const root::PubKey,
    ...
    pub mod Utils {
        ...
        extern "C" {
            #[link_name = "\u{1}N_Raw"]
            pub static String_Radix_Digits_N_Raw: u32;
        }
        extern "C" {
            #[link_name = "\u{1}N"]
